...
//         // Assuming you have a function to handle navigation to the OTP screen
//         navigateToOtpScreen();
//       } else {
//         console.error("Error:", response.status);
//         // Handle error case, show an alert or take appropriate action
...
//     // Navigate to the OtpScreen component
